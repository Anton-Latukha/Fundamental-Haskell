...
That distinction with synonims, would allow [[TypeSynonimInstances]], which would allow you to create a diffrent type class instances and behaviour for different information.

...
For functor instance to work [[Higher-kinded data type]]s type must be [[Functional application][applied]] until it has kind =( * -> * )=, and after functors can be [[Functional composition][composed]] to [[Lift][lift]] through layers of structure.
...
Also 1-tuple.
** Smart constructor
Place extra [[Constraints][constraints]] on the construction of values.
** Spine
#+begin_src text
Array:

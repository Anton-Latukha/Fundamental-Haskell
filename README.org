...
+ Used to pile up constraints/types first. At some point you would pick and satisfy constraints, you can do it one-by-one at a time.
- You can not formulate the term level and calculation processes, you just get the type hints from it.

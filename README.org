...
4) In Haskell often means particular "implementation" on top of some (considered well-known or basis to the code by the code author) theory/principle/abstraction mechanism.

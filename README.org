...
Term end-equating is more clear then =right-canselable=. Since "right" is collision between direction of composition (right to left), way it is drawn (left to right) and written \( C \to D \).

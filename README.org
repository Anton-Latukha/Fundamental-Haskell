...
#+latex_header:   \defaultfontfeatures{Ligatures=TeX}    % Should be enablead and autoloaded by default for fonts. Additions provided by luaotfload(i.e., LuaTEX only) to emulate TEX behaviour forASCII input of curly quotes and punctuation
#+latex_header:   \setmainfont{Latin Modern Roman}    % Computer Modern (mod Unicode extended) Serif {Analog Times New Roman}
#+latex_header:   \setsansfont{Latin Modern Sans}    % {Analog Arial}
#+latex_header:   \setmonofont{Latin Modern Mono}    % {Analog Consolas}
...
#+latex_header:   \setmonofont{CMU Typewriter Text}    % {Analog Consolas}
...
# #+latex_header:     Ligatures = TeX,    % Enablead and autoloaded by default. Additions provided by luaotfload(i.e., LuaTEX only) to emulate TEX’sbehaviour forASCII input of curly quotes and punctuation
...
# #+latex_header:   ]
# #+latex_header:   \setmathrm{XITSMath-Regular}    % Fontspec setup
# #+latex_header:   \setmainfont{XITS}[
# #+latex_header:     Ligatures = TeX,    % Enablead and autoloaded by default. Additions provided by luaotfload(i.e., LuaTEX only) to emulate TEX’sbehaviour forASCII input of curly quotes and punctuation
# #+latex_header:     Extension = .otf,
# #+latex_header:     UprightFont = *-Regular,
...
# #+latex_header:     BoldItalicFont = *-BoldItalic,
# #+latex_header:   ]
#+latex_header:   \usepackage{unicode-math}    % Typesetting engine for math fonts. Docs: http://mirror.datacenter.by/pub/mirrors/CTAN/macros/latex/contrib/unicode-math/unicode-math.pdf
#+latex_header:   \unimathsetup{math-style=ISO}    % Configures the unicode-math. ISO italizes all letters, bold also
# #+latex_header:   \setmathfont{Latin Modern Math}    % Latin Modern Math loaded by default, but let's show its load explicitly
# #+latex_header:   \setmathfont{XITSMath-Regular}[    % STIXS standard font for ISO publications
# #+latex_header:     Ligatures = TeX,    % Enablead and autoloaded by default. Additions provided by luaotfload(i.e., LuaTEX only) to emulate TEX’sbehaviour forASCII input of curly quotes and punctuation
# #+latex_header:     Extension = .otf,
# #+latex_header:     BoldFont = XITSMath-Bold
# #+latex_header:   ]
#+latex_header:   \usepackage{iftex}    % For detection of engines. LuaTeX SVG pkg requires it.
...
#+latex_header: \else
#+latex_header:   %default: pdf(La)TeX
#+latex_header:   \usepackage{lmodern} % load vector font
#+latex_header:   \usepackage[LFE,LAE,LGR,T1]{fontenc}    % LGR - de-facto standard Greek font support in LaTeX. Also pdfTex uses T1 for latin, LuaTex uses. LFE, LAE are for Arabic font support.
#+latex_header:   \usepackage[utf8]{inputenc} % input encoding
#+latex_header:   \usepackage[arabic,farsi,greek.ancient,english]{babel}
#+latex_header:   \usepackage[babel=true]{microtype}    % Load after Babel. Micro typesetting details for perfect typesetting of languages. Docs: http://mirror.datacenter.by/pub/mirrors/CTAN/macros/latex/contrib/microtype/microtype.pdf
#+latex_header: \fi
#+latex_header: \usepackage{tabularx}
#+latex_header: \usepackage{longtable}
#+latex_header: \usepackage{tabu}
#+latex_header: \usepackage{booktabs}
# #+latex_header: \usepackage{titlesec}    % Format the heading and labels. Docs: http://mirrors.ctan.org/macros/latex/contrib/titlesec/titlesec.pdf
# #+latex_header: \titlespacing{\subparagraph}{*1}{*1}{[hang]}
#+latex_header: \ifluatex    % Late stage LuaTeX setups
...
- [[#good-code][Good code]]
  ...
  - [[#good-orphan-instance][<<<Good: Orphan instance>>>]]

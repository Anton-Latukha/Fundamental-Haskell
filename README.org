...
Hom set belongs to Set.

In Set category: $$ \exists! (a, b) \iff \exists! Hom $$, $$ \forall Hom \in \ Set $$. So Set is special, Homs are also objects of it.

Category can have Set as internal category or not.

Universal construction:

\begin{tikzcd}
c \arrow[d, "u" description, dotted] & c \times a \arrow[d, "u \times 1^{a}" description, dotted] \arrow[rd] \arrow[l] &   \\
b^{a}                                & b^{a} \times a \arrow[r, "eval" description, dotted] \arrow[l]                  & b
\end{tikzcd}
, where in Category: \times - product bifunctor, $$ a $$ - argument of /*/, $$ b $$ - result, $$ c $$ - candidate, $$ b^{a} \equiv ( a \Rightarrow b ) $$ - /*/.

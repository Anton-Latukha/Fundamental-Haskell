...
By default, searches look at the [[http://hackage.haskell.org/platform][Haskell Platform]] and [[http://haskell.org/haskellwiki/Keywords][Haskell keywords]]. However, all [[http://hackage.haskell.org/][Hackage]] packages are available to search. As some examples:

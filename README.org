...
# #+PROPERTY: header-args:latex+ :packages '(("" "tikz-cd"))
...
#+latex_header: % Length to control the \fancyheadoffset and the calculation of \headline
#+latex_header: % simultaneously
# #+latex_header: \newlength\FHoffset
# #+latex_header: \setlength\FHoffset{0mm}
# #+latex_header: 
# #+latex_header: \addtolength\headwidth{2\FHoffset}
# #+latex_header: 
# #+latex_header: \fancyheadoffset{\FHoffset}
# #+latex_header: 
# #+latex_header: % these lengths will control the headrule trimming to the left and right 
# #+latex_header: \newlength\FHleft
# #+latex_header: \newlength\FHright
# #+latex_header: 
# #+latex_header: % here the trimmings are controlled by the user
# #+latex_header: \setlength\FHleft{0mm}
# #+latex_header: \setlength\FHright{0mm}
# #+latex_header: 
# #+latex_header: % The new definition of headrule that will take into acount the trimming(s)
# #+latex_header: \newbox\FHline
# #+latex_header: \setbox\FHline=\hbox{\hsize=\paperwidth%
# #+latex_header:   \hspace*{\FHleft}%
# #+latex_header:   \rule{\textwidth}{\headrulewidth}\hspace*{\FHright}%
# #+latex_header: }
# #+latex_header: \renewcommand\headrule{\vskip-.7\baselineskip\copy\FHline}
# #+latex_header: \renewcommand\headrule{\textwidth}
# #+latex_header: \renewcommand\headrule{\copy\FHline}
# #+latex_header: \renewcommand{\headrule}{\vbox to 0pt{\hboxto\headwidth{\dotfill}\vss}}

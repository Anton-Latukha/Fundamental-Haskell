...
Basic case: during implementation of monadic type composition, type =m T m a= arises, which does not allow to =join= transformation for the =m= monadic layers or to have a regular unit transformation.

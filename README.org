...
Each dimension of the cube corresponds to extensions (a new way of objects depending on objects):
  * Polymorhic types - (First-class polymorphism) - terms allowed to depend on types, corresponding to polymorphism.
  * Type operations - (Type class) - types depending on types, corresponding to type operators.
  * Depended types - (Higher-rank polymorphism) - types depending on terms, corresponding to dependent types.

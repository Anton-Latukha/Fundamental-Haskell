...
To prettify radio targets in =Emacs= with =Elisp= snippet to prettify =<<<Radio targets>>>= to _Radio targets_:
...
- [[#drafts][Drafts]]
  ...
  - [[#layering-transformers][Layering transformers]]
  - [[#hoogle][Hoogle]]
    - [[#search][Search]]
    - [[#scope-1][Scope]]
      - [[#default][Default]]
...
:DRILL_LAST_REVIEWED: [2020-02-08 Sat 22:42]
:end:
...
:DRILL_EASE: 2.6
:DRILL_LAST_QUALITY: 4
:DRILL_LAST_REVIEWED: [2020-01-23 Thu 23:14]
:end:
...
:DRILL_EASE: 2.7
:DRILL_LAST_QUALITY: 5
:DRILL_LAST_REVIEWED: [2020-01-23 Thu 23:10]
:end:
...
:DRILL_EASE: 2.7
:DRILL_LAST_QUALITY: 5
:DRILL_LAST_REVIEWED: [2020-01-23 Thu 23:12]
:end:
...
:DRILL_EASE: 2.46
:DRILL_LAST_QUALITY: 5
:DRILL_LAST_REVIEWED: [2020-01-23 Thu 23:07]
:end:
...
:DRILL_EASE: 2.32
:DRILL_LAST_QUALITY: 3
:DRILL_LAST_REVIEWED: [2020-02-08 Sat 22:53]
:end:
...
:DRILL_EASE: 2.46
:DRILL_LAST_QUALITY: 5
:DRILL_LAST_REVIEWED: [2020-01-23 Thu 23:20]
:end:
...
:DRILL_EASE: 2.18
:DRILL_LAST_QUALITY: 3
:DRILL_LAST_REVIEWED: [2020-02-08 Sat 22:47]
:end:
...
:DRILL_EASE: 2.0
:DRILL_LAST_QUALITY: 5
:DRILL_LAST_REVIEWED: [2020-02-08 Sat 22:36]
:end:
...
:DRILL_EASE: 2.46
:DRILL_LAST_QUALITY: 5
:DRILL_LAST_REVIEWED: [2020-02-08 Sat 22:56]
:end:
...
:DRILL_EASE: 2.7
:DRILL_LAST_QUALITY: 5
:DRILL_LAST_REVIEWED: [2020-01-23 Thu 23:25]
:end:
...
:DRILL_EASE: 2.7
:DRILL_LAST_QUALITY: 5
:DRILL_LAST_REVIEWED: [2020-01-23 Thu 23:19]
:end:
...
:DRILL_EASE: 2.7
:DRILL_LAST_QUALITY: 5
:DRILL_LAST_REVIEWED: [2020-01-23 Thu 23:24]
:end:
...
:DRILL_EASE: 2.56
:DRILL_LAST_QUALITY: 5
:DRILL_LAST_REVIEWED: [2020-02-08 Sat 22:57]
:end:
...
:DRILL_EASE: 1.8
:DRILL_LAST_QUALITY: 3
:DRILL_LAST_REVIEWED: [2020-01-23 Thu 23:13]
:end:
...
:DRILL_EASE: 2.7
:DRILL_LAST_QUALITY: 5
:DRILL_LAST_REVIEWED: [2020-01-23 Thu 23:11]
:end:
...
=foldl= spine recursion is unconditional, then folding starts.

=foldr= can terminate at any point, while =foldl= unconditionally recurses across the whole spine, if it infinite - infinitely.
...
** Layering transformers

Mix of the the monad transformers is functionality is the same, but the form is different. Surrounding handling functions would need to be different. 
...
(Since asis of logic is tautologically True and Void value can not be adressed - there is a logical paradox with the Void)

Is an object in Hask category, since:
#+begin_src haskell
:t (id :: Void -> Void)
...
Gesign pattern: use polymorphic data types and Void to get rid of possibilities when you need to.
...
#  2020-02-19: NOTE: Update after package is used
\begin{document}
\usepackage{tikz-cd}
\begin{tikzcd}
...
In Cartesian closed monoidal category.

Hom set belongs to Set, but Set can be not part of category.

In Set category: $$ \exists! (a, b) \iff \exists! Hom $$, $$ \forall Hom \in \ Set $$. So Set is special, Homs are also objects of it.

Universal construction:

\begin{document}
\begin{tikzcd}
z \arrow[d, "h", dotted]            & z \times a \arrow[d, "h \times 1", dotted] \arrow[rd, "g"] &   \\
(a \Rightarrow b) \arrow[r, dotted] & (a \Rightarrow b) \times a \arrow[r, "eval", dotted]       & b
\end{tikzcd}
\end{document}

, where in Category: $$ a $$ - argument of /*/, $$ b $$ - result, $$ z $$ - candidate, $$ ( a \Rightarrow b ) $$ - /*/.

/*/ $$ (a \Rightarrow b) $$ also called exponential, marked $$ b^{a} $$ that represent exponentiation of cardinality of $$ \forall b^{a} $$ possiblities.

Cartesian category should be closed under exponentiation.

...
Every identity morphisms translates into identity morphism,
...
Composing in source category and translating at once - is a much-much more effective computation (it is known under name of functor <<<fusion>>>).

...
Algebraic data type construction can use:
  * Type constructor
  * 
Product and coproduct are functorial.

** <<<Lax monoidal functor>>>

** <<<Const functor>>>

Maps all objects of source category into one (fixed) object of source category, and all morphisms to identity morphism of that fixed object.
...
In Category theory denoted: $$ \Delta $$.

Last time parameter that bears the type of source is proxy type.

...
#+latex_header:     % Lua(La)TeX
#+latex_header:     %\setmainlanguage[spelling=new,babelshorthands=true]{german}
...
# #+latex_header:     \setmathfont{XITSMath-Regular}[    % In fact loads XITSMath
# #+latex_header:       Ligatures = TeX,    % Enablead and autoloaded by default. Additions provided by luaotfload(i.e., LuaTEX only) to emulate TEX’sbehaviour forASCII input of curly quotes and punctuation
# #+latex_header:       Extension = .otf,
...
#+latex_header: \usepackage{polyglossia}    % It is advisable to activate the languages after all packages havebeen loaded. Docs: http://mirrors.ctan.org/macros/latex/contrib/polyglossia/polyglossia.pdf
#+latex_header: \setdefaultlanguage[variant=us]{english}
#+latex_header: \setotherlanguage[variant=ancient]{greek}
#+latex_header: \setotherlanguage[variant=classic]{latin}
#+latex_header: \setotherlanguage{arabic}   % Especcially right-to-left languages must be activated after all packages loaded
...
# Trying to make LuaTeX work
# #+html_head: \usepackage{fontspec}
# #+html_head: \setsansfont{CMU Sans Serif}%{Arial}
# #+html_head: \setmainfont{CMU Serif}%{Times New Roman}
# #+html_head: \setmonofont{CMU Typewriter Text}%{Consolas}
# #+html_head: \defaultfontfeatures{Ligatures={TeX}}

# Trying to make universal preamble pdfTex LuaTex work
# #+latex_header: \PassOptionsToPackage{greek.ancient,arabic,farsi,english}{babel}
# #+latex_header: \usepackage{uni8}
...
[[file:images/2020-03-11_18-28-08_State_Monad_Bind.svg]]

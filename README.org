...
Nonsensical proposition that has {impossible, not full, false} premise and as such - impossible to definitely prove true nor false inside the particular theory.

Such proposition fall into paradox due to property of excluded middle in the classical logic.
...
Abstract structure that consists of partially ordered set which has a property of any two elements having unique supremum and infinum.

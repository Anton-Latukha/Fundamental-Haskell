...
:END:
  * set of elements
  * binary operation
  * set is a closure under operation,
  * associativity of operation
  * identity element
  * inverse for every element (element operation with inverse gives identity)
 
*** /*/
<<<Groups>>>
*** <<<Commutative group>>>
In which operation obeys the axiom of commutativity.
...
Fundamental algebraic structure:
  * Set closed under operations
  * binary operation, generalization of addition
  * binary operation, generalization of multiplication (no requirement of commutativity)
  * forms a commutative group in operation of addition

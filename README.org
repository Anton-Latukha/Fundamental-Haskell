...
- [[#good-code][Good code]]
  ...
  - [[#good-sometimes-the-proper-nature-algorithm-is-not-a-computation-way][<<<Good: Sometimes the proper nature algorithm is not a computation way>>>]]
- [[#bad-code][Bad code]]
...
** <<<Good: Sometimes the proper nature algorithm is not a computation way>>> :drill:
:PROPERTIES:

...
#+captions: \lambda-cube generalization of typed tystem from \lambda-calculus to calculus of constructions, and the tree degrees (axis) of expansion
...
#+captions: Three degrees of generalizations of typed systems

...
Fundamental algebraic structure:
  * Set closed under + and \times
  * generalized binary operation + (addition)
  * generalized binary operation \times (multiplication) (no requirement for commutativity)
  * under + (commutative) forms a commutative group
  * + and \times obey distributive axiom

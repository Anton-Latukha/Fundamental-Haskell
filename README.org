...
/*/ is end-canselable morphism. Since epimorphism covers target fully - \forall morphisms composed to its end (target) are fully operational in composition and so fully comparable between each other.

Term end-canselable is more clear then ~right-canselable~.

Since there is collision between direction of composition (right to left)

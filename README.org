...
One that contains Hom objects (replacing knowledge of Hom sets from Set). Hom objects are includedd in monoidal category (multiplication operation allowing composition of Hom objects).

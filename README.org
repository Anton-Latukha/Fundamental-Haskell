...
#+latex_header:     \setmainfont{CMU Serif}    % Computer Modern Unicode Serif {Analog Times New Roman}
...
# #+latex_header:       BoldItalicFont = *-BoldItalic,
# #+latex_header:     ]
#+latex_header:     \usepackage{unicode-math}    % Docs: http://mirror.datacenter.by/pub/mirrors/CTAN/macros/latex/contrib/unicode-math/unicode-math.pdf

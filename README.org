...
/Book became too popular (underground scene wibe here), to address that - it would go through proper cleaning of presonal Org-drill metadata./
/Current book form reached limits of radio cross-linking scaling of the Emacs Org-mode, the book would migrate to Org-roam and gain even more representational possibilities/.
/Book also needs to be published in form of the Anki card deck for Anki users. Did you know that Anki is direct development from Org-drill v1?/
...
- [[#draft][Draft]]
  ...
  - [[#algorithm-of-the-hackage-package-release][Algorithm of the Hackage package release]]
    ...
    - [[#left-remove-git-tag][Left (Remove git tag)]]

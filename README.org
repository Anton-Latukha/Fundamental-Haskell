...
Functor type class in Haskell corresponds to mathematical power set functor and allows do function application inside type structure layers (denoted /f/ or /m/). IO is also such structure.

...
# #+latex_header: \setlist[enumerate,3]{label*=$\arabic*.$}
# #+latex_header: \setlist[enumerate,4]{label*=$\arabic*.$}
# #+latex_header: \setlist[enumerate,5]{label*=$\arabic*.$}
# #+latex_header: \setlist[enumerate,6]{label*=$\arabic*.$}
# #+latex_header: \setlist[enumerate,7]{label*=$\arabic*.$}
# #+latex_header: \setlist[enumerate,8]{label*=$\arabic*.$}
# #+latex_header: \setlist[enumerate,9]{label*=$\arabic*.$}
# #+latex_header: \setlist[enumerate,10]{label*=$\arabic*.$}

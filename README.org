...
/*/ embodies in itself any endofunctor. It is easily seen from Haskell definition - that the /*/ here is the polymorphic generalization of any endofunctor in a category. Application of a function to /*/ gives a particular endofunctor (see Hask category).
...
Composed functors can lift functions through any layers of structures that belong to Functor type class.
...
:DRILL_EASE: 2.28
:DRILL_LAST_QUALITY: 3
:DRILL_LAST_REVIEWED: [2019-08-17 Sat 00:28]
:END:

Final evaluation. Produces the function result.
...
:DRILL_EASE: 2.9
:DRILL_LAST_QUALITY: 5
:DRILL_LAST_REVIEWED: [2019-08-17 Sat 01:27]
:END:

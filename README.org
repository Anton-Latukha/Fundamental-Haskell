...
- [[#definitions][Definitions]]
  ...
  - [[#function][<<<Function>>>]]
    ...
    - [[#function-application-1][<<<Function application>>>]]
      - [[#-73][/*/]]
...
/*/ map between two algebraic structures of the same type which operation-preserving.

$$ f_{x \to y} = f_{a_x \star b_x} = f(a_x) \diamond f(b_x) $$,
where $$ x,\ y $$ are sets with additonal algebraic structure that includes $$ \star, \diamond $$ accordingly; $$ a,\ b $$ are elements of sets.

/*/ sends identity morphisms to identity morphisms and inverses to inverses.

The concept of /*/ has been generalized under the name of morphism to many other structures that either do not have an underlying set, or are not algebraic.

...
\begin{tikzcd}
                          &  & T^{3} \arrow[lldd, "\mu \circ I" description, bend right=49] \arrow[rrdd, "I \circ \mu" description, bend left=49] &  &                           \\
                          &  &                                                                           &  &                           \\
T^{2} \arrow[rrdd, "\mu" description] &  &                                                                           &  & T^{2} \arrow[lldd, "\mu" description] \\
                          &  &                                                                           &  &                           \\
                          &  & T
\end{tikzcd}

...
:DRILL_EASE: 2.52
:DRILL_LAST_QUALITY: 5
:DRILL_LAST_REVIEWED: [2019-09-03 Tue 23:52]
:END:
...
Ranking: $$ \max{\sum^{\forall}{(!: c\prime \to c \ | \ p\prime = p \circ !, \ q\prime = q \circ !)}} $$, where $$ c\prime $$ is another candidate.

/*/ is a pair. Corresponds to product type in Hask.

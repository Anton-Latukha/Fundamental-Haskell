...
Structural Type System is a strict global hierarchy and relationship of types and their properties.
Mathematical [[Type][type]], form [[Structural type system]].
Haskell type system is /*/.
In most languages typing is not [[Structural type][structural]] - but name-based.
** Superclass :drill:
:PROPERTIES:
